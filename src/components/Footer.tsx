...
import { MapPin, Phone, Mail, Globe, Leaf, Award, FilePhone, Building, ExternalLink } from 'lucide-react';
                ...
                <span className="text-bunshodo-medium-gray">
                  ...
                  <div className="mt-1">
                    ...
                    <div className="flex items-center text-sm">
                      <FilePhone className="h-4 w-4 text-bunshodo-blue mr-1 flex-shrink-0" />
